      ...
      <div className="relative z-20 py-32">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-black bg-opacity-70 border border-tipaix-light border-opacity-20 backdrop-blur-sm">
            {/* Decorative frame */}
            <div className="absolute -inset-4 border border-tipaix-light border-opacity-10"></div>
            ...
            <div className="p-12 space-y-12">
              <section>
                ...
                <div className="text-purple-200 font-light space-y-2 leading-relaxed">
                  ...
                  <p>Site web : <a href="https://www.micim.fr" target="_blank" rel="noopener noreferrer" className="text-tipaix-light hover:text-purple-300 underline">www.micim.fr</a></p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="w-12 h-px bg-tipaix-light mb-6"></div>
                <div className="text-purple-200 font-light space-y-2 leading-relaxed">
                  <p><span className="text-tipaix-light font-medium">Vercel Inc.</span></p>
              ...
              <section>
                ...
                <div className="text-purple-200 font-light space-y-4 leading-relaxed">
                  <p>
                    Le contenu de ce site web (textes, images, vidéos, etc.) est la propriété de 
                    l'association MICIM et de La Tipaix, sauf mention contraire. Toute reproduction, même partielle, 
              ...
              <section>
                ...
                <div className="text-purple-200 font-light space-y-4 leading-relaxed">
                  <p>
                    Le site met à disposition un formulaire de contact permettant aux visiteurs 
                    de nous adresser leurs demandes.
                  </p>
                  <p>
                    <span className="text-tipaix-light font-medium">Données collectées :</span> nom, adresse email, 
                    sujet et contenu du message.
                  </p>
                  <p>
                    <span className="text-tipaix-light font-medium">Finalité :</span> ces données sont utilisées 
                    exclusivement pour répondre à vos demandes de renseignements.
                  </p>
                  <p>
                    <span className="text-tipaix-light font-medium">Traitement :</span> les messages sont envoyés 
                    directement par email aux responsables de MICIM et de La Tipaix.
                  </p>
                  <p>
                    <span className="text-tipaix-light font-medium">Conservation :</span> les données sont conservées 
                    pendant une durée maximale de 1 an.
                  </p>
                  <p>
                    <span className="text-tipaix-light font-medium">Responsables du traitement :</span> Sébastien Chombard et Marc Potard.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="text-purple-200 font-light space-y-4 leading-relaxed">
                  ...
                  <p>
                    Vos données ne sont pas transmises à des tiers et ne font l'objet d'aucune 
                    commercialisation.
                  </p>
                  <p>
                    Pour exercer vos droits, contactez-nous à : 
                    <span className="text-tipaix-light font-medium"> micim@micim.fr</span>
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="w-12 h-px bg-tipaix-light mb-6"></div>
                <p className="text-purple-200 font-light leading-relaxed">
                  Ce site ne utilise aucun cookie. Il fonctionne sans système de tracking, 
                  de publicité ou de collecte de données de navigation.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="text-purple-200 font-light space-y-4 leading-relaxed">
                  <p>
                    L'association MICIM s'efforce d'assurer l'exactitude et la mise à jour des 
